...
$(function() {$('body').wrapInner('<div id="ll-general">');});
    ...
    if (!ll.extended) {
        $.extend(ll, {
            ...
            layerMethods: {
                ...
                position: function(value) {
                    ...
                    switch(ll.options.position) {
                        case 'middle':
                            $('#ll-cell').css('vertical-align', 'middle');
                            break;
                        case 'third':
                            ...
                            $('#ll-holder').css('margin-top', '20px');
                            break;
                        case 'top':
                            $('#ll-cell').css('vertical-align', 'top');
                            break;
                    }
                ...
                exit: function() {
                    var actions = function() {
                            ...
                            ll.layer.popup.removeClass('ll-pop');
            ...
            popupMethods: {
                ...
                move: function(obj) {
                    ll.layer.popup.addClass('ll-pop').appendTo($('#ll-holder'));
                    obj.remove();
            ...
            init: {
                layer: function() {
                    ...
                    $('body').addClass('lightlayer').append(
                        $('<div>', {id: 'lightlayer', tabindex: '1'})
                            .css({'display': 'table'}).append(
                                $('<div>', {id: 'll-cell'}).append(
                                    $('<div>', {id: 'll-holder'})
                                )
                            )
                    );
